...
public class TopoAlgoritmi {
     ...
     * pisteSaalis-taulukkoon painavimman reitin solmuun. Solmut siis
     * käsitellään sellaisessa järjestyksessä, että jo käsitellyihin silmuihin
     * ei osoita enää nuolia myöhemmin käsitellyistä solmuista eikä niiden
     * pistesaldo siis enää muutu.
     */
    ...
    /*
    Etsii ensin pisteSaalis-taulukosta missä pisteessä on saavutettu paras pistearvo 
    ja luo sitten linkitetyn listan kulkemalla 'takaisinpäin' reitti-listassa.
    */
    ...
    /*
    *Testauskäyttöön.
    * Palauttaa algoritmin täyttääneen taulukon, johon on kirjattu minkä indeksisestä solmusta on tultu mihinkin solmuun.
    */
    public int[] getReitti() {
        return this.reitti;
    }

    public int getParasPistemaara() {
        return this.parasPisteSaalis;
    }
    ...
    /**
     * Palauttaa tulokset stringinä muodossa "Paras reitti oli -parasreitti-, ja sen arvo oli -reitin arvo-.
     */
